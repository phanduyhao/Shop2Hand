...
namespace Shop2Hand.Areas.Admin.Controllers
{
    ...
    public class AdminAccountController : Controller
    {
        ...
        public AdminAccountController(Shop2HandContext context, INotyfService notyfService)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var Shop2HandContext = _context.Accounts.Include(a => a.Role);
            return View(await Shop2HandContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Shop2HandContext.Accounts'  is null.");
            }
            var account = await _context.Accounts.FindAsync(id);
            if (account != null)
            {
